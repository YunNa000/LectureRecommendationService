...
# Original data augmented by repeating with small random variations
klas_data = {
    'find specific major': [5, 5, 4, 4, 5, 5, 4, 4, 5, 4, 5, 4, 5, 4, 5, 4],
    'find specific gyoyang': [5, 5, 4, 5, 5, 5, 4, 4, 5, 4, 5, 4, 5, 5, 4, 5],
    'find specific subjects': [5, 5, 5, 4, 5, 5, 4, 5, 5, 4, 5, 5, 4, 5, 5, 4],
    'want to use it later': [5, 5, 4, 5, 5, 5, 4, 5, 5, 4, 5, 4, 5, 5, 4, 5]
}

everytime_data = {
    'find specific major': [3, 3, 3, 2, 4, 1, 3, 3, 3, 2, 3, 2, 3, 2, 3, 4],
    'find specific gyoyang': [1, 3, 3, 2, 2, 1, 4, 4, 2, 3, 2, 3, 2, 3, 2, 3],
    'find specific subjects': [1, 2, 4, 3, 2, 3, 2, 2, 2, 3, 2, 3, 2, 3, 2, 3],
    'want to use it later': [1, 4, 3, 4, 2, 2, 3, 5, 2, 3, 2, 4, 3, 2, 3, 4]
}
