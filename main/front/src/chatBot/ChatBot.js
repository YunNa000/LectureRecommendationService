...
(입학년도/편입년도) (전공) (다전공여부) 졸업요건

으로 검색하면 본인의 졸업요건을 알 수 있어요. 19년도 이후 신입학자만 해당됩니다.
- 예) 21학번 정보융합학부 단일전공의 졸업요건을 알려줘`;
...
어떤 점이 궁금하세요?`;
      case "교내전화번호안내":
        return `<교내전화번호안내>에서는 안내받은 번호를 02-940 뒤에 붙여주시면 돼요.
- 예) 정보융합학부(정융) 과사무실
- 예) 홍길동 교수님 
- 예) 졸업 문의`;
          ...
          <>
            <div className="intro-section">
              ...
              <div className="intro-message">
                <p>
                  수강신청자료집에 대한 모든 것을 알고 있어요😏 다른 테마로 넘어가면 기존에 작성했던 채팅은 자동으로 삭제됩니다.
                  <br />
                  <br />
                  궁금한 테마를 선택해주세요.
                </p>
